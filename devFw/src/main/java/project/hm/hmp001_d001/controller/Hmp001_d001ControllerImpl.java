...
public class Hmp001_d001ControllerImpl implements Hmp001_d001Controller{
	...
	@Override 
	@RequestMapping(value = "/hm/hmp001_d001/searchInit.do", method = { RequestMethod.GET, RequestMethod.POST })
	...
	public ModelAndView searchList(@RequestParam(value="p_id", required=false) String p_id, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		// Autowired없이 bean의 인스턴스 생성하기 ??
		//WebApplicationContext context = ContextLoader.getCurrentWebApplicationContext(); 
		//hmp001_d001Service = (Hmp001_d001Service)context.getBean(Hmp001_d001Service.class, "hmp001_d001Service");
	...
	//@RequestMapping(value = "/common/xmlTest", produces="application/xml", method = { RequestMethod.GET, RequestMethod.POST })
	@RequestMapping(value = "/common/xmlTest",  method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public Map<String, Object> xmlTest(HttpServletRequest request, HttpServletResponse response) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("id", "hong");
		map.put("name", "홍길동");
	...
	@RequestMapping("/common/jsonMakeTest")
	@ResponseBody
	public String jsonMakeTest(HttpServletRequest request, HttpServletResponse response) throws JsonProcessingException {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("id", "hong");
		map.put("name", "홍길동");
