...
<script language="javascript">
	...
	function LoadPage() {
		...
		initSheet.Cols = [
			...
			{Header:"ID",Type:"Text",SaveName:"id",MinWidth:80,Align:"Center", UpdateEdit:false},
			{Header:"비밀번호",Type:"Text",SaveName:"pwd",MinWidth:80,KeyField:1 ,MultiLineText:1, UpdateEdit:false},			
			...
			{Header:"Date",Type:"Date",SaveName:"joinDate",MinWidth:100},
			{Header:"숫자",Type:"Int",SaveName:"num",MinWidth:60},
			{Header:"버튼",Type:"Button",SaveName:"BUTTON",DefaultValue:"상세정보",MinWidth:100,Align:"Center",Cursor:"Default"}
		];   
