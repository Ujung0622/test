...
<%@ page import="com.spring.mvc.ex05.component.EventType" %>
...
<form:form commandName="eventForm" action="/springMvcSample/newevent/done.do">
...
<a href="/springMvcSample/newevent/step2.do">[이전 단계로]</a>
